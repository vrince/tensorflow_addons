...
#include <thread>
#include "tensorflow_addons/custom_ops/image/cc/kernels/distance_transform/dope_vector/grid.hpp"
...
class DistanceTransform
{
  public:
	...
	inline static void distanceTransformL2(const dope::DopeVector<Scalar, DIM> &f,
										   dope::DopeVector<Scalar, DIM> &D, const bool squared = false,
	...
	inline static void distanceTransformL2(const dope::DopeVector<Scalar, 1> &f,
...
#include "tensorflow_addons/custom_ops/image/cc/kernels/distance_transform/inlines/distance_transform.inl"
