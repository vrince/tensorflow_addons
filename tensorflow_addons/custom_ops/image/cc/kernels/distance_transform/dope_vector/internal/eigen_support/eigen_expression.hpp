...
#include "tensorflow_addons/custom_ops/image/cc/kernels/distance_transform/dope_vector/internal/expression.hpp"
#include <Eigen/Core>
...
class EigenStaticArrayBinaryExpression : public StaticArrayExpression<EigenStaticArrayBinaryExpression<Derived, Er, T, Dimension, Op>, T, Dimension>
{
	static_assert((Eigen::MatrixBase<Derived>::RowsAtCompileTime == Dimension && Eigen::MatrixBase<Derived>::ColsAtCompileTime == 1) ||
					  (Eigen::MatrixBase<Derived>::RowsAtCompileTime == 1 && Eigen::MatrixBase<Derived>::ColsAtCompileTime == Dimension),
				  "Eigen object must be a vertical vector.");
...
#include "tensorflow_addons/custom_ops/image/cc/kernels/distance_transform/dope_vector/internal/inlines/eigen_support/EigenExpression.inl>
