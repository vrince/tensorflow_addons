...
#include <memory>
#include <array>
#include "tensorflow_addons/custom_ops/image/cc/kernels/distance_transform/dope_vector/dope_vector.hpp"
...
inline DopeVector<T, Dimension>::DopeVector()
	: _array(nullptr), _accumulatedOffset(static_cast<SizeType>(0)), _size(IndexD::Zero()), _offset(IndexD::Zero())
{
}

template <typename T, SizeType Dimension>
inline DopeVector<T, Dimension>::DopeVector(T *array, const SizeType accumulatedOffset, const IndexD &size)
	: _array(array), _accumulatedOffset(array ? accumulatedOffset : static_cast<SizeType>(0)), _size(array ? size : static_cast<const IndexD &>(IndexD::Zero())), _offset(IndexD::Zero())
{
	if (array)
	{
...
inline DopeVector<T, Dimension>::DopeVector(T *array, const SizeType accumulatedOffset, const IndexD &size, const IndexD &offset)
	: _array(array), _accumulatedOffset(array ? accumulatedOffset : static_cast<SizeType>(0)), _size(array ? size : static_cast<const IndexD &>(IndexD::Zero())), _offset(array ? offset : static_cast<const IndexD &>(IndexD::Zero()))
{
}
...
inline DopeVector<T, 1>::DopeVector()
	: _array(nullptr), _accumulatedOffset(static_cast<SizeType>(0)), _size(Index1::Zero()), _offset(Index1::Zero())
{
}

template <typename T>
inline DopeVector<T, 1>::DopeVector(T *array, const SizeType accumulatedOffset, const SizeType size)
	: _array(array), _accumulatedOffset(array ? accumulatedOffset : static_cast<SizeType>(0)), _size(array ? Index1::Constant(size) : Index1::Zero()), _offset(array ? Index1::Ones() : Index1::Zero())
{
}

template <typename T>
inline DopeVector<T, 1>::DopeVector(T *array, const SizeType accumulatedOffset, const SizeType size, const SizeType offset)
	: _array(array), _accumulatedOffset(array ? accumulatedOffset : static_cast<SizeType>(0)), _size(array ? Index1::Constant(size) : Index1::Zero()), _offset(array ? Index1::Constant(offset) : Index1::Zero())
{
}

template <typename T>
inline DopeVector<T, 1>::DopeVector(T *array, const SizeType accumulatedOffset, const Index1 &size)
	: _array(array), _accumulatedOffset(array ? accumulatedOffset : static_cast<SizeType>(0)), _size(array ? size : static_cast<const Index1 &>(Index1::Zero())), _offset(array ? Index1::Ones() : Index1::Zero())
{
}

template <typename T>
inline DopeVector<T, 1>::DopeVector(T *array, const SizeType accumulatedOffset, const Index1 &size, const Index1 &offset)
	: _array(array), _accumulatedOffset(array ? accumulatedOffset : static_cast<SizeType>(0)), _size(array ? size : static_cast<const Index1 &>(Index1::Zero())), _offset(array ? offset : static_cast<const Index1 &>(Index1::Zero()))
{
}
